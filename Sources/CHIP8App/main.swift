...
func my_main() {
    ...
    guard var surface = SDL_CreateRGBSurfaceFrom(nil, 64, 32, 32, 0, 0x00FF0000, 0x0000FF00, 0x000000FF, 0xFF000000)?.move()
        else { return }
    ...
    let content = surface.pixels?.assumingMemoryBound(to: UInt8.self)
